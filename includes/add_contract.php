...
function addContract($dataInsert, $services_ids)
{
    try {
        ...
        if ($existingContract) {
            ...
            $stmt = $pdo->prepare("INSERT INTO contract (room_id, tenant_id, tenant_id_2, tinhtrangcoc, ngaylaphopdong, ngayvao, ngayra, create_at) VALUES (:room_id, :tenant_id, :tenant_id_2, :tinhtrangcoc, :ngaylaphopdong, :ngayvao, :ngayra, :create_at)");
