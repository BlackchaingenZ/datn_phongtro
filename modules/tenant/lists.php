                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td class="zoom-image" style="text-align: center;"><a href="<?php echo getLinkAdmin('tenant', 'view-pre', ['id' => $item['id']]); ?>" target="_blank"><?php echo (isFontIcon($item['anhmattruoc'])) ? $item['anhmattruoc'] : '<img src="' . $item['anhmattruoc'] . '"  width=70 height=50/>' ?></a></td>
                                <td class="zoom-image" style="text-align: center;"><a href="<?php echo getLinkAdmin('tenant', 'view-after', ['id' => $item['id']]); ?>" target="_blank"><?php echo (isFontIcon($item['anhmatsau'])) ? $item['anhmatsau'] : '<img src="' . $item['anhmatsau'] . '"  width=70 height=50/>' ?></a></td>
                                <td style="text-align: center;">
